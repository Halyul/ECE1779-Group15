...
from album.aws.dynamoDB_common import \
    KEY_IMAGE_TABLE, dynamodb, SHARED_LINK_TABLE, db_get_shared_link_table_attributes
from album.aws.dynamoDB_user import db_is_allowed_get_shared_image


def db_get_image_by_key_admin(key):
    ...
    if 'Item' not in response:
        ...
        # records['thumbnail'] = "data:{};base64,".format(thumbnail.mimetype).encode("utf-8") + base64.b64encode(
        #     thumbnail.read())
